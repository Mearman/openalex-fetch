 ...
 */
export function instanceOfInternationalDisplayNameAndDescription(value: object): boolean {
    let isInstance = true;
...
export function InternationalDisplayNameAndDescriptionFromJSONTyped(json: any, ignoreDiscriminator: boolean): InternationalDisplayNameAndDescription {
    ...
    return {
        ...
        'description': !exists(json, 'description') ? undefined : InternationalDescriptionFromJSON(json['description']),
        'displayName': !exists(json, 'display_name') ? undefined : InternationalDisplayNameFromJSON(json['display_name']),
    };
}
