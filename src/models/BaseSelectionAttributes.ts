 ...
 * 
 * @export
 * @interface BaseSelectionAttributes
 */
export interface BaseSelectionAttributes {
}

/**
 * Check if a given object implements the BaseSelectionAttributes interface.
 */
export function instanceOfBaseSelectionAttributes(value: object): boolean {
    let isInstance = true;
