 ...
 */
export function instanceOfInternationalDisplayName(value: object): boolean {
    let isInstance = true;
...
export function InternationalDisplayNameFromJSONTyped(json: any, ignoreDiscriminator: boolean): InternationalDisplayName {
    ...
    return {
        ...
        'displayName': !exists(json, 'display_name') ? undefined : InternationalisationFromJSON(json['display_name']),
    };
}
