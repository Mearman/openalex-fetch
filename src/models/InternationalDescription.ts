 ...
 */
export function instanceOfInternationalDescription(value: object): boolean {
    let isInstance = true;
...
export function InternationalDescriptionFromJSONTyped(json: any, ignoreDiscriminator: boolean): InternationalDescription {
    ...
    return {
        ...
        'description': !exists(json, 'description') ? undefined : InternationalisationFromJSON(json['description']),
    };
}
