 ...
 * 
 * @export
 * @interface NgramsApiInterface
 */
export interface NgramsApiInterface {
    /**
     * 
 ...
 * 
 */
export class NgramsApi extends runtime.BaseAPI implements NgramsApiInterface {
